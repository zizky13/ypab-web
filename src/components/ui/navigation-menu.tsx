...
const navigationMenuTriggerStyle = cva(
  "group/navigation-menu-trigger inline-flex h-9 w-max items-center justify-center rounded-3xl px-4.5 py-2.5 text-lg font-medium transition-all outline-none hover:underline data-popup-open:underline data-[state=open]:underline"
)
